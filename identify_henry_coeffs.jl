...
using CairoMakie,CSV, DataFrames, ColorSchemes, Distributions, Optim, PlutoUI, Colors, JLD2, LinearAlgebra, ScikitLearn, PyCall, LaTeXStrings, LinearAlgebra
...
# ╔═╡ 361fdf26-2158-4f0c-8215-e25373dfa790
#Pkg.add("CairoMakie")
...
md"!!! example \"\"
	Declare utility data structures to be used in data processing such as lists of names of gases, mofs, filename for the CSV file etc...
"
...
function viz_henry_barplot()
	...
	ax = Axis(fig[1,1], 
		      ...
		      ylabel="Henry coefficient [g/(g-bar)]"
	)
...
# ╔═╡ b346f400-7df3-4db7-9f47-7a9823fa4e5f
norm(p_null)
